...
class BlackoutPreparationIntroView extends StatelessWidget {
  const BlackoutPreparationIntroView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Spacer(),
        Text(
          language.t('blackout_prep_intro_title'),
        ...
        Text(
          language.t('blackout_prep_intro_body'),
        ...
        const Spacer(),
        _PrimaryButton(label: language.t('onboarding_continue'), onTap: onContinue),
