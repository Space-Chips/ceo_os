...
- focus and productivity settings

### Productivity and App Content
- tasks
...
- selected websites or domains you choose to restrict
- schedules, planned pauses, time windows, and daily limits
- related configuration required to apply those restrictions

### Subscription and Billing Information
- Premium entitlement status
- subscription state
- product identifiers
- purchase and restoration status necessary to manage access

### Technical and Security Information
- service logs
- error and diagnostics information
- metadata necessary for synchronization, fraud prevention, abuse prevention, and service reliability
...
- sync your settings and records across supported sessions or devices
- provide focus, planning, and restriction features
- calculate or display progress, history, and insights
- activate, restore, and verify Premium access
- maintain platform security, diagnose failures, and prevent abuse
...
These permissions are used to support user-initiated blocking and daily-limit features on-device.

More specifically:
- Accessibility may be used to detect when a selected distracting app or supported website is opened so the app can apply the blocking shield
...
- legitimate interests, such as service security, fraud prevention, debugging, abuse prevention, and product reliability
- your consent, where a feature depends on your optional choice, such as enabling certain permissions or choosing Google Sign-In
...
### Google Play
Used for Android app distribution, subscription billing, and related platform services where applicable.

These providers process information only as needed to provide their part of the service.
