...
- Premium features are billed through your Apple ID via the App Store.
- Subscriptions auto-renew unless you cancel at least 24h before the end of the current period (via iOS Settings → Apple ID → Subscriptions).
- Pricing is shown in the app before purchase.
- Refunds are handled by Apple under their refund policy: https://support.apple.com/en-us/HT204084
- We may change pricing for future renewals with at least 30 days notice.

## 4. Your content

- You retain ownership of your tasks, habits, notes and any content you create.
